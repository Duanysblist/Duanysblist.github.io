<%-- 
    ...
    Created on : Jan 16, 2019, 5:00:44 PM
    Author     : Dan's Laptop
--%>
                ...
                <div class="table-responsive">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>Is it a hero Organization?</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td><c:out value="${organization.orgName}"></c:out></td> 
                                <td><c:out value="${organization.orgContactInfo}"></c:out></td> 
                                <td><c:out value="${organization.orgDescription}"></c:out></td>
                                <td><c:out value="${organization.isHeroOrg}"></c:out></td>
                            </tr>  
                        </tbody>
                    </table>
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                                ...
                                <c:forEach var="currentPerson" items="${organizationMembers}">
                                <tr>
